                        ...
                        <div class="modal fade" id="addUserModal" aria-labelledby="addUserModal" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form id="form-add-product" action="" enctype="multipart/form-data" method="post">
                                        <div class="modal-body">
                                            <div class="row">
                                                ...
                                                <div class="col-6"><label>Giá</label><input class="form-control my-2" type="text" placeholder="Giá" name="price" required/></div>
                                            </div>
                                            <div class="form-group"><label>Hình ảnh</label><input class="form-control my-2" type="text" placeholder="Chèn liên kết ảnh ở đây" name="sale" required/></div>
                                        </div>
                            ...
                            <tbody>
                                ...
                                while ($row =  mysqli_fetch_row($res)) {
                                    ...
                                    echo "
                                        ...
                                        <button class=\"btn-delete btn btn-danger btn-xs\" style=\"margin-right: 5px\" data-bs-id='$row[0]' data-bs-target='#DeleteProductModal' data-bs-toggle='modal'><svg xmlns='http://www.w3.org/2000/svg' width='13' height='13' fill='currentColor' class='bi bi-trash3' viewBox='0 0 16 16'>
